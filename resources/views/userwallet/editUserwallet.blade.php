...
<div class="m-4">
    ...
    <div class="card grey-card p-2">
        <div class="card-body col-md-12 p-4">
            ...
            <form enctype="multipart/form-data" action="/editUserwallet/{{$userwallet->wallet_id}}" method="POST" class="m-2 mx-4">
                {{method_field('PUT')}}
                @csrf
                <div class="row mt-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <input type="text" class="form-control" value="{{ $userwallet->wallet->name }}" readonly>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        <input type="text" name="amount" value="{{$userwallet->amount}}" required class="form-control">
                    </div>
                </div>
